...
* File manager
 Sunrise Commander! I’m not changing much, just disabling the mouse and adding buttons.
...
(use-package sunrise-commander
  ...
  :init
    ...
    (setq sr-cursor-follows-mouse 1)
    (define-key sr-mode-map [mouse-1] 1)
    (define-key sr-mode-map [mouse-movement] 1)
  :bind ("s-t" . sunrise))
